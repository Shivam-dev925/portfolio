...
const navigation = [
    ...
    {
        name: 'X',
        href: 'https://x.com/SHIVAMC84334661',
        icon: (props) => (
    ...
    {
        name: 'GitHub',
        href: 'https://github.com/Shivam-dev925',
        icon: (props) => (
            <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                <path
                    fillRule="evenodd"
...
export default function Footer() {
    ...
    return (
        <div className="absolute bottom-4 inset-x-0 border-t border-white/10  px-4 py-4 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24 sm:hidden ">
            ...
            <p onClick={navigateToHome} className="cursor-pointer mt-8 text-sm/6 text-gray-400 md:order-1 md:mt-0">
                Shivam choudhary
            </p>
        </div>)
}